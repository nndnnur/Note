...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        simpanCatatan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (judulCatatan.getText().toString().isEmpty()) {
                    Toast.makeText(getApplicationContext(), "You have to write something", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (edit) {
                    masukkanCatatan = dbHelper.updateCatatan(sgd, id);
                } else {
                ...
                if (masukkanCatatan) {
                    ...
                    Toast.makeText(getApplicationContext(), "Opps! There's something wrong", Toast.LENGTH_SHORT).show();
                }
                dbHelper.close();
        ...
        //Metode klik untuk tombol membatalkan pembuatan catatan
    ...
    private void dialogDaftarCatatan () {
        ...
        if (listDaftar.getAdapter().getCount() < 1) {
            judulDaftar.setText("Opps! You haven't take a note yet");
        } else {
